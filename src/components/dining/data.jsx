...
const iniData = [
    // Breakfast
        ...
        { name: "Hash Brown Patty", calories: 150, prob: ['soy, ', 'vegetarian, ', 'vegan, '], time: "Breakfast", location: "FOD", image: "../HashBrownPatty.jpg", date: badDate, favorite: false },
        ...
        { name: "Buttermilk Pancakes", calories: 180, prob: ['Milk, ', 'eggs, ', 'wheat, ', 'soy, ', 'gluten, ', 'vegetarian'], time: "FOD", location: "Marketplace",image: "../ButtermilkPancakes.jpg", date: badDate, favorite: false  },
        { name: "Scrambled Eggs", calories: 190, prob: ['eggs, ','vegetarian'], time: "Breakfast", location: "FOD",image: "../ScrambledEggs.jpg", date: badDate, favorite: false  },
    ...
    // // Lunch
        ...
        { name: "Sauteed Spinach & Caramelized Onions", calories: 45, prob: ['vegetarian, ', 'vegan, ', 'mindful'], image: "../Spinach.jpg", time: "Lunch", location: "Marketplace", date: date, badDate, favorite: false },
        { name: "Butter Tofu", calories: 240, prob: ['milk, ', 'soybean, ', 'vegetarian'], time: "Lunch", image: "../Tofu.jpg", location: "Marketplace", date: badDate, favorite: false },
        ...
        { name: "Basmati Rice With Green Peas", calories: 130, prob: ['vegetarian, ', 'vegan, ', 'mindful'], time: "Lunch", location: "FOD", image: "../RicenPea.jpg", date: badDate, favorite: false },

    // // Dinner
        { name: "Spicy Shrimp & Vegetable Stir Fry", calories: 360, prob: ['shrimp, ', 'vegan'], time: "Lunch", location: "FOD", image: "../ShimpV.jpg", date: badDate, favorite: false },
        { name: "Vegetable Fried Rice", calories: 170, prob: ['egg, ', 'wheat, ', 'soybean, ', 'gluten, ', 'vegetarian'], time: "Lunch", location: "FOD", image: "../RiceV.jpg", date: badDate, favorite: false },
        { name: "Spicy Tofu & Vegetable Stir Fry", calories: 420, prob: ['wheat, ', 'soybeans, ','sesame, ', 'gluten, ', 'vegetarian, ', 'vegan'], time: "Lunch", location: "FOD", image: "../TofuV.jpg", date: badDate, favorite: false },

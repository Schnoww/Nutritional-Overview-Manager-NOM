...
const Marketplace = () => {
	...
	const filteredFood = iniData.filter((food) => food.location === "FOD");
	...
	return (
		<div className="w-full flex justify-center p-6 bg-gray min-h-screen overflow-y-auto">
			<div className="w-full max-w-3xl space-y-4">
				...
				<h1 className="text-4xl font-bold text-white text-center mb-6">Food On Demand</h1>
						...
						<div className="flex-1">
							<div className="flex items-center justify-between">
								<div className="flex items-center space-x-4">
									{/* Food image */}
									<img
										src={food.image || "../FOD.png"} // Fallback image if none exists
										alt={food.name}
